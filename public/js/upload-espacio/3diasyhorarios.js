...
var newDia = function newDia(dia, horacomienzo, horafin, horacomienzovalue, horafinvalue){
  ...
  nuevodia.innerHTML = "<input type='text' name='diasemana["+dia+"]' class='upload-input-dia' value='"+dia+"' readonly> <input type='text' class='upload-input-hora' value='"+horacomienzo+"' disabled> <span style='text-align:center;'> - </span> <input type='text' name='' class='upload-input-hora' value='"+horafin+"' disabled> <label onclick='borrarHorario(event)' class='upload-label-horario-button'>&#8854;</label> <hr style='margin: 10px 0px;'> <input type='text' name='horacomienzo["+dia+"]' class='upload-input-hora' value='"+horacomienzovalue+"' style='display:none;'><input type='text' name='horafin["+dia+"]' class='upload-input-hora' value='"+horafinvalue+"' style='display:none;'>"
