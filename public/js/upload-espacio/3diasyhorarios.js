...
var newDia = function newDia(dia, horacomienzo, horafin, horacomienzovalue, horafinvalue){
  ...
  nuevodia.innerHTML = "<div class='input-field col s3 offset-s1'><input type='text' name='diasemana["+dia+"]' class='upload-input-dia' value='"+dia+"' readonly></div> <div class='input-field col s3'><input type='text' class='upload-input-hora' value='"+horacomienzo+"' disabled></div> <div class='input-field col s3'><input type='text' name='' class='upload-input-hora' value='"+horafin+"' disabled></div> <label onclick='borrarHorario(event)' class='upload-label-horario-button'>&#8854;</label> <hr style='margin: 10px 0px;'> <input type='text' name='horacomienzo["+dia+"]' class='upload-input-hora' value='"+horacomienzovalue+"' style='display:none;'><input type='text' name='horafin["+dia+"]' class='upload-input-hora' value='"+horafinvalue+"' style='display:none;'>"
