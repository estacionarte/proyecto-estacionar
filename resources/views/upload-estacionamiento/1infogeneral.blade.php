      ...
      <section class="uploadEstacionamiento">
        ...
        <div class="form-generico">
          ...
          <form action='{{ route('create.espacio') }}' method="post" enctype="multipart/form-data" class="form-uploadEstacionamiento">
            ...
            <input type="text" placeholder="Domicilio. Ej: Av. Eduardo Madero 399" name="direccion" class="upload-input-direccion" style="" value="{{ old('direccion') }}">
            <input type="text" placeholder="Nº Dpto. (Opcional)" name="dpto" class="upload-input-numdpto" value="{{ old('dpto') }}">
            ...
            <input type="text" placeholder="Código Postal" name="zipcode" class="upload-input-cp" style="" value="{{ old('zipcode') }}">
            ...
            <label for="" class="upload-label-tipovehiculo">Autos</label> <input type="number" placeholder="" name="cantAutos" class="upload-input-tipovehiculo" min="0" max="1" value="{{ old('cantAutos') }}">
            <label for="" class="upload-label-tipovehiculo">Motos</label> <input type="number" placeholder="" name="cantMotos" class="upload-input-tipovehiculo" min="0" max="4" value="{{ old('cantMotos') }}">
            <label for="" class="upload-label-tipovehiculo">Bicicletas</label> <input type="number" placeholder="" name="cantBicicletas" class="upload-input-tipovehiculo" min="0" max="4" value="{{ old('cantBicicletas') }}">
            ...
            <textarea name="infopublica" maxlength="250" value="{{ old('infopublica') }}"></textarea>

            <label for="" class="upload-label-titulo">Información extra (únicamente visible por quienes alquilen tu espacio) -opcional-</label>
            <textarea name="infoprivada" maxlength="250" value="{{ old('infoprivada') }}"></textarea>
