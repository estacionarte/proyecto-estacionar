        ...
        <div class="form-generico">
          ...
          <form action="{{ route('insert.upload.espacio.resumen', $espacio) }}" method="post" class="form-uploadEspacio form-reducido">
            ...
            <div class="upload-div-precio">
              ...
              <select name="descuentoPorMinutoSeisHoras" class="upload-input-descuentoPorMinuto" required>
                <option value="" selected>Descuento</option>
                <option value=0.2>20</option>
                <option value=0.3>30</option>
                <option value=0.4>40</option>
            ...
            <div class="">
              ...
              <label for="">Días:</label><input type="text" name="" value=0 id="dias-calculadora">
              <label for="">Horas:</label><input type="text" name="" value=3 id="horas-calculadora">
              <label for="">Minutos:</label><input type="text" name="" value=30 id="minutos-calculadora">

              <p>Por dejar el auto <span id="dias-resultado">0</span> dias, <span id="dias-resultado">3</span> horas y <span id="dias-resultado">30</span> minutos recibirás $<span id="ganancia-resultado"></span></p>
